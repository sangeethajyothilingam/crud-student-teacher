...
const formvalidationSchema = yup.object({
  ...
  mother_name: yup.string().required().min(4),
  father_name: yup.string().required().min(4),
  contact: yup.string().required().min(10),
  address: yup.string().required().min(5),
});

function AdmissionForm({ studentdata, setstudentData }) {
        ...
        <div className="row mt-4 ps-5">
          <div className="col-lg-5  mt-5">
            ...
            <input
              type="text"
              className={`form-control ${
                myFormik.touched.standard && myFormik.errors.standard
                  ? "is-invalid"
                  : "is-valid"
              }`}
            ...
            <input
              type="text"
              className={`form-control ${
                myFormik.touched.roll_no && myFormik.errors.roll_no
                  ? "is-invalid"
                  : "is-valid"
              }`}
            ...
            <input
              type="text"
              className={`form-control ${
                myFormik.touched.mother_name && myFormik.errors.mother_name
                  ? "is-invalid"
                  : "is-valid"
              }`}
          ...
          <div className="col-lg-5 mt-5 ms-0">
            <input
              type="text"
              className={`form-control ${
                myFormik.touched.father_name && myFormik.errors.father_name
                  ? "is-invalid"
                  : "is-valid"
              }`}
